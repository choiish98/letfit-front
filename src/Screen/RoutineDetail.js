...
const RoutineDetail = (props) => {
  ...
  const routineDetail = () => {
    ...
    // 요일 별 부위
    fetch(
      `https://tender-words-shop-121-146-124-174.loca.lt/api/routines/${routineId}/days`,
      {
        headers: {
          method: "GET",
        },
    ...
    // 전체 운동 저장
    fetch(
      `${`https://tender-words-shop-121-146-124-174.loca.lt`}/api/routines/${routineId}/exercises`,
      {
        headers: {
          method: "GET",
        },
